...
*/
  ...
  //% weight=10
  export function IC_ThingSpeak(apikey: string, f1: string, f2: number, f3: string, f4: number, f5: string, f6: number, f7: string, f8: number): void {
  	let printT2 = "AT+CIPSTART=\"TCP\",\"120.102.238.119\",80"
  	serial.writeString(printT2 + "\u000D" + "\u000A")
  	basic.pause(4000)
  	let printT3 = "GET /receive.asp?sno=" + apikey + "&name1=" + f1 + "&value1=" + f2 + "&name2=" + f3 + "&value2=" + f4 + "&name3=" + f5 + "&value3=" + f6 + "&name4=" + f7 + "&value4=" + f8
